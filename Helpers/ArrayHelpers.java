...
public class ArrayHelpers {
    ...
    public static Object[] shuffle(Object[] arr) {
        ...
        //Declare variables to store the object stored for swapping and the randomly generated index, respectively
        Object temp;
        int randomIndex;
        //Iterate through array BACKWARDS
        for (int i = arr.length - 1; i > 0; i--) {
            //Get a random number which is NEVER THE SAME as i's value
            do {
                randomIndex = (int) (Math.random() * arr.length);
            } while (randomIndex == i);
            //Swap the i'th element and the randomly selected index
            temp = arr[i];
